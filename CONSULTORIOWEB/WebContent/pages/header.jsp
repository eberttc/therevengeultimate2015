	      ...
	      <div class="navbar-collapse collapse">
	        <ul class="nav navbar-nav">
	          ...
	          <li class="dropdown">
	            ...
	            <ul class="dropdown-menu">	             
	              <li><a href="<%=request.getContextPath()%>/AtencionServlet" target="_top">Registro Atencion</a></li>	              
	          ...
	          <li class="dropdown">
	            ...
	            <ul class="dropdown-menu">	             
	              <li><a href="<%=request.getContextPath()%>/ReservaCitaServlet" target="_top">Citas</a></li>	              
